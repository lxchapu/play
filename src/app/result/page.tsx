...
export default function ResultPage() {
  ...
  return (
    <div className="min-h-screen bg-slate-950 py-10 px-4 flex flex-col items-center justify-start relative selection:bg-emerald-500/30">
      <div
        id="report-card"
        className={`w-full max-w-md bg-slate-900 border ${isAnomaly ? "border-purple-700/50 shadow-[0_0_40px_rgba(168,85,247,0.3)]" : "border-slate-700/80 shadow-[0_0_40px_rgba(0,0,0,0.5)]"} relative overflow-hidden flex flex-col rounded-sm animate-[fadeIn_0.5s_ease-out]`}
      >
      ...
      {/* 外部操作按钮区 */}
      <div className="flex flex-col sm:flex-row gap-4 mt-8 w-full max-w-md animate-[fadeIn_1s_ease-out_0.5s_both]">
        <button
          type="button"
