...
export const Transition = ({ logs }: { logs: string[] }) => {
  return (
    <div className="w-full max-w-2xl mx-auto bg-slate-900/80 border border-slate-700 p-6 rounded-lg font-mono text-sm md:text-base text-emerald-400/80 shadow-[0_0_30px_rgba(16,185,129,0.1)]">
